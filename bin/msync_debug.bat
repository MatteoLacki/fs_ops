...
python C:/Projects/fs_ops/bin/msync.py D:/Data/raw_sync_test/hash_tests M:/test_sync2 "F9-9-2020_14-59-30_Training2_56.d" --min_copy_hours .0001 --min_delete_hours .0001 --debug
pause
